...
JLabel label1,label2,label3,label4,label5,label6,label7,label8,label9,label10,label11,label12,label13,s1,s2,s3;
JPanel panel;
JFrame jf;
JButton register,b1,b2;
JTextField textfield1,textfield2,textfield3,textfield4a,textfield4b,textfield4c,textfield5,textfield6,textfield7,textfield8,textfield9,textfield10;
...
b1.setBounds(30, 1, 90, 40);
b2.setBounds(110, 1, 70, 40);
panel.add(b1);
panel.add(b2);
...
st1.executeUpdate("INSERT INTO user_details  VALUES('"+name+"','"+gender+"','"+password+"','"+dobb+"','"+
		mobileNumber+"','"+email+"','"+area+"','"+state+"','"+nationality+"' ,null)");
st1.close();
con.close();
